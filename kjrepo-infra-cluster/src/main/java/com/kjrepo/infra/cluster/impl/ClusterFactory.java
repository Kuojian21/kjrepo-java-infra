package com.kjrepo.infra.cluster.impl;
...
import com.kjrepo.infra.register.group.GroupRegisterListener;
import com.kjrepo.infra.register.group.context.GroupRegisterFactory;

public class ClusterFactory {

	public static <R, I, C extends ClusterInfo<I>> Cluster<R> gcluster(Class<C> cclazz, Class<I> iclazz, String key,
			Function<InstanceInfo<I>, R> mapper, ThrowableConsumer<R, Exception> release) {
		return gcluster(GroupRegisterFactory.getContext().getGroupRegister(cclazz, iclazz), key, mapper, release);
	}
	...
	public static <R, I, C extends ClusterInfo<I>> Cluster<R> cluster(Class<C> cclazz, String key,
			Function<InstanceInfo<I>, R> mapper, ThrowableConsumer<R, Exception> release) {
		return cluster(RegisterFactory.getContext().getRegister(cclazz), key, mapper, release);
	}
