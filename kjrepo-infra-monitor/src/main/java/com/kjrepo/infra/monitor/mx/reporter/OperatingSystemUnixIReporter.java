...
public class OperatingSystemUnixIReporter
		extends AbstractIReporter<UnixOperatingSystemMXBean, OperatingSystemReporterUnixBean> {

	@Override
	public Map<String, Object> doReport(UnixOperatingSystemMXBean bean) {
