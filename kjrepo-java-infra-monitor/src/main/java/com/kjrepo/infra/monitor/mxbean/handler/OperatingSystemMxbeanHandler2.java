...
import com.kjrepo.infra.monitor.mxbean.holder.OperatingSystemMxbeanHolder2;

public class OperatingSystemMxbeanHandler2
		extends AbstractMxbeanHandler<OperatingSystemMXBean, OperatingSystemMxbeanHolder2> {
